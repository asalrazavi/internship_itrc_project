...
$(function () {
  ...
  document.addEventListener('drop', (e) => {
    ...
    $('#id_evaluation_script_custom_text').text(e.dataTransfer.files[0].name);
  ...
  $('#id_evaluation_script').change(function (e) {
    $('#id_evaluation_script_custom_text').text(this.files[0].name);
  });
